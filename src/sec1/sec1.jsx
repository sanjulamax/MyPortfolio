...
<ul><li className=' font-bold'>University of Moratuwa</li></ul>
  <li>Python for Beginners <a href={Imgs.PY} className='ml-[12%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a>  </li>
  <li> Web Design for Beginners<a href={Imgs.WD} className='ml-[0%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a></li>
  <li> Front-End Web Design<a href={Imgs.FD} className='ml-[9%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a></li>
<br></br><br></br>
<ul><li className=' font-bold'>SoloLearn</li></ul> 
                            <li>Python <a href={Imgs.python} className='ml-[18%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a></li>
                            <li> Java <a href={Imgs.java} className='ml-[26%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a></li>
                            <li> JavaScript<a href={Imgs.js} className='ml-[12%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a></li>
  
  <li> SQL<a href={Imgs.sql} className='ml-[28%] pl-[5px] pr-[5px]   text-green-600 font-mono font-bold rounded-md'>view</a></li>
 
  <li> HTML<a href={Imgs.html} className='ml-[23%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a></li>
  

  
  <li> C Language <a href={Imgs.c} className='ml-[5%] pl-[5px] pr-[5px]  text-green-600 font-mono font-bold rounded-md'>view</a></li><br></br><br></br> 
...
These certifications highlight my proficiency in both foundational and advanced concepts across multiple programming languages and web development technologies.
                   ...
                   <div className='flex items-center justify-center'><a href={Imgs.CV}> <button className=' bg-blue-700 border-2 border-blue-700 rounded-lg text-white p-[10px] mt-[20px]'>VIEW MY CV</button></a></div>
